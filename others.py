...
# Переменные / функции
bot_token = '5075551980:AAEALDT2_uRek7E4dWI5vpa3eL9AoFdvgYg'		# 
admin_user_id = 1054762938 											#  
channel_id = 											# 

token = 'edb157ad202ab9547cda5c2688f963a9' 							# qiwi token
phone = '79257003542'												# qiwi number
...
group = "@poiskadm" # канал с отзывами, готовый вариант, можно оставить

bot_name = "@@uy_hqd_pod_bot" #username бота без @
